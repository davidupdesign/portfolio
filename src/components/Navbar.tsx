...
export default function Navbar() {
  ...
  return (
    <header className="relative top-0 left-0 right-0 z-50 pointer-events-none">
      <nav className="flex items-center justify-between mx-auto container-narrow px-6 py-5">
        ...
        <div
          ...
          style={{
            ...
            WebkitMaskImage:
              "linear-gradient(to bottom, transparent 20%, black 40%, transparent 80%)",
            maskImage:
              "linear-gradient(to bottom, transparent 20%, black 40%, transparent 80%)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(to bottom, rgba(10,10,10,0.6) 0%, rgba(10,10,10,0.3) 40%, rgba(10,10,10,0.2) 70%, transparent 100%)",
          }}
        />
        {/* left - logo */}
        <Link
